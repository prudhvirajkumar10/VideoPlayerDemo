...
public class RTMPActivity extends AppCompatActivity implements IVLCVout.Callback {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mFilePath = getIntent().getStringExtra(VideoLinks.VIDEOLINK);
    ...
    private void createPlayer(String media){
        ...
        try {
            if (media.length() > 0) {
                Toast toast = Toast.makeText(this, "Playing source from: " + media, Toast.LENGTH_LONG);
    ...
    public void onHardwareAccelerationError(IVLCVout vlcVout) {
        Log.e("RTMP", "Error with hardware acceleration");
        this.releasePlayer();
        ...
        public void onEvent(MediaPlayer.Event event) {
            ...
            switch (event.type) {
                case MediaPlayer.Event.EndReached:
                    Log.d("RMTP", "MediaPlayerEndReached");
